                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-sm-3 col-3 order-1">
                            <div class="logo_container">
                                <div class="logo"><a href="{{ url('/') }}">Happy Mart</a></div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 footer_col">
                            <div class="footer_column footer_contact">
                                <div class="logo_container">
                                    <div class="logo"><a href="#">Happy Mart</a></div>
                                </div>
                                <div class="footer_title">Got Question? Call Us 24/7</div>
                                <div class="footer_phone">+088017654323</div>
                                <div class="footer_contact_text">
                                    <p>17 Princess Road, Dhaka</p>
                                    <p>Grester Dhaka NW18JR, Bangladesh</p>
                                </div>
                        ...
                        <div class="col">
                            ...
                            <div
                                ...
                                <div class="logos ml-sm-auto">
                                    <ul class="logos_list">
                                        <li><a href="#"><img
                                                    src="{{ asset('/') }}/frontend/images/logos_1.png"
                                                    alt=""></a></li>
                                        <li><a href="#"><img
                                                    src="{{ asset('/') }}/frontend/images/logos_2.png"
                                                    alt=""></a></li>
                                        <li><a href="#"><img
                                                    src="{{ asset('/') }}/frontend/images/logos_3.png"
                                                    alt=""></a></li>
                                        <li><a href="#"><img
                                                    src="{{ asset('/') }}/frontend/images/logos_4.png"
                                                    alt=""></a></li>
                                    </ul>
                                </div>
                            </div>
