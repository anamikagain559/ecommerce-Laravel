                            ...
                            <div class="owl-carousel owl-theme deals_slider">
                                @foreach ($hot as $ht)
                                    ...
                                    <div class="owl-item deals_item">
                                        <div class="deals_image"><img src="{{ asset($ht->image_one) }}"
                                        ...
                                        <div class="deals_content">
                                            ...
                                            <div class="deals_info_line d-flex flex-row justify-content-start">
                                                ...
                                                @endif
                                                @if ($ht->discount_price != null)
                                                    <div class="deals_item_price ml-auto">$ {{ $ht->discount_price }}
                                                    </div>
                                                @else
                                                @endif
                                ...
                                <div class="row fill_height">
                                    <div class="col-lg-4 col-md-6 fill_height">
                                        <div class="banner_2_content">
                                            ...
                                            <div class="banner_2_text">{{ $row->brand_name }} <br>Product Id:
                                                {{ $row->product_code }}.</div>
                                    ...
                                    <div class="col-lg-8 col-md-6 fill_height">
                                        <div class="banner_2_image_container">
                                            <div class="banner_2_image"><img src="{{ asset($row->image_one) }}"
                                                    style="height: 300px; width: 320px;"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="featured_slider_item">
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        class="product_image d-flex flex-column align-items-center justify-content-center">
                                                        <img src="{{ asset($row->image_one) }}"
                                                            style="height: 120px; width: 130px;"></div>
                                                    <div class="product_content">
                                                        @if ($row->discount_price == null)
                                ...
                                <div class="owl-item">
                                    <div class="trends_item is_new">
                                        <div
                                            ...
                                            <img src="{{ asset($row->image_one) }}" style="height: 220px;"></div>
                        ...
                        <div class="owl-carousel owl-theme viewed_slider">
                            ...
                            <div class="owl-item">
                                <div
                                    ...
                                    <div class="viewed_image"><img
                                            src="{{ asset('/') }}/frontend/images/view_1.jpg" alt=""></div>
                            ...
                            <div class="owl-item">
                                <div
                                    ...
                                    <div class="viewed_image"><img
                                            src="{{ asset('/') }}/frontend/images/view_2.jpg" alt=""></div>
                                    <div class="viewed_content text-center">
                            ...
                            <div class="owl-item">
                                <div
                                    class="viewed_item d-flex flex-column align-items-center justify-content-center text-center">
                                    <div class="viewed_image"><img
                                            src="{{ asset('/') }}/frontend/images/view_3.jpg" alt=""></div>
                                    <div class="viewed_content text-center">
                            ...
                            <div class="owl-item">
                                <div
                                    ...
                                    <div class="viewed_image"><img
                                            src="{{ asset('/') }}/frontend/images/view_4.jpg" alt=""></div>
                                    <div class="viewed_content text-center">
                                        <div class="viewed_price">$379</div>
                            ...
                            <div class="owl-item">
                                <div
                                    class="viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                    <div class="viewed_image"><img
                                            src="{{ asset('/') }}/frontend/images/view_5.jpg" alt=""></div>
                                    <div class="viewed_content text-center">
                                        <div class="viewed_price">$225<span>$300</span></div>
                            ...
                            <div class="owl-item">
                                <div
                                    class="viewed_item d-flex flex-column align-items-center justify-content-center text-center">
                                    <div class="viewed_image"><img
                                            src="{{ asset('/') }}/frontend/images/view_6.jpg" alt=""></div>
                                    <div class="viewed_content text-center">
