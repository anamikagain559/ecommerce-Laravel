...
@section('content')
    ...
    <div class="contact_form">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 " style="border-right: 0px solid grey; margin-left: 200px;">
                    <div class="cart_container">
                        ...
                        <div class="list-group col-lg-12">
                            ...
                            <li class="list-group-item">Shipping Charge: <span style="float: right;"> $
                                    {{ $charge }}</span></li>
                ...
                <div class="col-lg-8 " style=" margin-left: 200px;">
                    <div class="cart_container">
                        <form action="{{ route('cashonedelivery') }}" method="post" id="payment-form"
                            style="border: 1px solid grey; padding: 30px;">
                            @csrf
                            <div class="form-row">
                                <label for="card-element">
                                    You have Select Cash On Delivery Payment Method
                                </label>
                            ...
                            <button class="btn btn-info">Please Conform Order</button>
                        </form>
    ...
    <script type="text/javascript">
        ...
        var stripe = Stripe(
            'pk_test_51KKiyCFaH4bcSD9MuVe65TvF4I6YUYXeJQ6eiurQIABUYXnquK8ei2Qo3c5iQ81kmXIuPs5Ky5D6OKgHCR2nRsyJ00ZOwK5TeP'
        );
