                    ...
                    <div class="cart_container">
                                    ...
                                    <li class="cart_item clearfix">
                                        ...
                                        <div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
                                            ...
                                            <div class="cart_item_price cart_info_col">
                                                ...
                                                <div class="cart_item_text">BDT{{ $row->price }}</div>
                                            </div>
                                            <div class="cart_item_total cart_info_col">
                                                <div class="cart_item_title">Total</div>
                                                <div class="cart_item_text">BDT{{ $row->price * $row->qty }}</div>
                                            </div>
                        ...
                        <ul class="list-group col-lg-8">
                            @if (Session::has('coupon'))
                                <li class="list-group-item">Subtotal : <span style="float: right;"> BDT
                                        {{ Session::get('coupon')['balance'] }}</span> </li>
                                <li class="list-group-item">Coupon : ({{ Session::get('coupon')['name'] }}) <span
                                        style="float: right;"> BDT {{ Session::get('coupon')['discount'] }} </span> </li>
                            @else
                                <li class="list-group-item">Subtotal : <span style="float: right;"> BDT
                            ...
                            <li class="list-group-item">Shipping Charge: <span style="float: right;"> BDT
                                    {{ $charge }}</span></li>
                            <li class="list-group-item">Vat : <span style="float: right;"> 0</span></li>
                            @if (Session::has('coupon'))
                                <li class="list-group-item">Total: <span style="float: right;"> BDT
                                        {{ Session::get('coupon')['balance'] + $charge }}</span> </li>
                            @else
                                <li class="list-group-item">Total: <span style="float: right;">BDT
                                        {{ Cart::Subtotal() + $charge }} </span> </li>
                            @endif
                        </ul>
                    </div>
                </div>
                            ...
                            <div class="form-group">
                                <ul class="logos_list ">
                                    ...
                                    <li><input type="radio" name="payment" value="paypal"> <img
                                            src="{{ asset('frontend/images/paypal.png') }}" style="width: 100px;">
                                    </li>
                                    <li><input type="radio" name="payment" value="cash_on_delivery"> <img
                                            src="{{ asset('frontend/images/mobile.jpg') }}"
                                            style="width: 100px; height: 50px; border-radius: 10px;"></li>
                                </ul>
                            </div><br>
